...
## Description
A Python application to manage and create projects with CRUD operations.
...
- Leaders can assign tasks to team members, facilitating communication and the sharing of
